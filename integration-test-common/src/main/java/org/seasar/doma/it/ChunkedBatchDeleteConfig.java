...
/**
 * A {@link Config} decorator that constructs {@link ChunkedAutoBatchDeleteQuery} instead of {@link
 * AutoBatchDeleteQuery}, so batch deletes execute one chunk of SQL at a time and keep memory
 * bounded for large entity lists.
 */
public class ChunkedBatchDeleteConfig implements Config {

  private final Config delegate;

  private final QueryImplementors queryImplementors;

  public ChunkedBatchDeleteConfig(Config delegate) {
