...
/**
 * A {@link Config} decorator that constructs {@link ChunkedAutoBatchInsertQuery} instead of {@link
 * AutoBatchInsertQuery}, so batch inserts execute one chunk of SQL at a time and keep memory
 * bounded for large entity lists.
 */
public class ChunkedBatchInsertConfig implements Config {

  private final Config delegate;

  private final QueryImplementors queryImplementors;

  public ChunkedBatchInsertConfig(Config delegate) {
