...
class KSubSelectFromDeclaration<ENTITY>(private val declaration: SubSelectFromDeclaration<ENTITY>) : SubSelectContext<ENTITY> {
    ...
    fun having(block: KHavingDeclaration.() -> Unit): KSubSelectFromDeclaration<ENTITY> {
        declaration.having { block(KHavingDeclaration(it)) }
        return this
    }
