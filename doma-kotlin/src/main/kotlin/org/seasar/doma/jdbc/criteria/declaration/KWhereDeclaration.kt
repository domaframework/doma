...
class KWhereDeclaration(declaration: WhereDeclaration) : KComparisonDeclaration<WhereDeclaration>(declaration) {
    ...
    fun <PROPERTY> between(
            propertyMetamodel: PropertyMetamodel<PROPERTY>, start: PROPERTY?, end: PROPERTY?) {
    ...
    fun <PROPERTY> `in`(
            left: PropertyMetamodel<PROPERTY>, right: SubSelectContext<PropertyMetamodel<PROPERTY>>) {
        declaration.`in`(left, right)
    }
