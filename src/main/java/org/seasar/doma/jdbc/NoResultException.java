...
/**
 * Thrown to indicate that the number of fetched rows is expected more than 0,
 * but actually it is 0.
 */
public class NoResultException extends JdbcException {
    ...
    public NoResultException(SqlLogType logType, SqlKind kind, String rawSql, String formattedSql,
            String sqlFilePath) {
