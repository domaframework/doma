...
public class Oracle11Dialect extends StandardDialect {
    ...
    public static class Oracle11SqlLogFormattingVisitor extends StandardSqlLogFormattingVisitor {
        ...
        /**
         * A formatter that converts a {@link Timestamp} object to a timestamp
         * literal.
         */
        ...
        /**
         * A formatter that converts a {@link java.util.Date} object to a date
         * literal.
         */
        ...
        /**
         * A formatter that converts a {@link LocalDate} object to a date
         * literal.
         */
        ...
        /**
         * A formatter that converts a {@link LocalDateTime} object to a
         * timestamp literal.
         */
        ...
        /**
         * A formatter that converts a {@link LocalTime} object to a time
         * literal.
         */
