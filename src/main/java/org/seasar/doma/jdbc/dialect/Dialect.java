 ...
 * <p>
 * This interface absorb the difference between {@literal RDBMS}s.
 * <p>
...
public interface Dialect {
     ...
     *             if unsupported options are specified
     */
     ...
     * @return
     * @throws DomaNullPointerException
     *             if {@code sqlException} is {@code null}
     */
    boolean isUniqueConstraintViolated(SQLException sqlException);

    /**
     * Whether this object includes the IDENTITY column in SQL INSERT
     * statements.
     * 
     * @return
     */
     ...
     * 
     * @param type
     *            a kind of pessimistic locking
     * @param withTargets
     *            {@code true} if a lock target is specified
     * @return
     */
    boolean supportsSelectForUpdate(SelectForUpdateType type, boolean withTargets);

    /**
     * Whether this object supports an out parameter that is mapped to a result
     * set in stored functions or stored procedures .
     * 
     * @return
     */
    ...
    /**
     * Returns an SQL object to get IDENTITY values that are generated in the
     * database.
     * <p>
     * This method is available, only if {@link #supportsIdentity()} returns
     * {@code true}.
     * 
     * @param catalogName
     *            the catalog name
     ...
     *            the table name
     * @param columnName
     *            the IDENTITY column name IDENTITYカラムの名前
     * @param isQuoteRequired
     *            whether the quotation marks are required
     * @param isIdColumnQuoteRequired
     *            whether the quotation marks are required for the IDENTITY
     *            column
     * @return the SQL object
     * @throws DomaNullPointerException
     *             if either the {@code tableName} or the {@code columnName} is
     *             {@code null}
     */
     ...
     * <p>
     * This method is available, only if {@link #supportsIdentityReservation()}
     * returns {@code true}.
     * 
     * @param catalogName
     *            the catalog name
     ...
     * <p>
     * This method is available, only if {@link #supportsSequence()} returns
     * {@code true}.
     * 
     ...
     * @return the SQL object
     * @throws DomaNullPointerException
     *             if {@code qualifiedSequenceName} is {@code null}
     */
    Sql<?> getSequenceNextValSql(String qualifiedSequenceName, long allocationSize);

    /**
     * Returns the {@link JdbcType} object that corresponds to the
     * {@link ResultSet} class.
     * <p>
     * This method is available, only if
     * {@link #supportsResultSetReturningAsOutParameter()} is {@code true}.
     * 
     ...
     * 
     * @param name
     *            the name of a database object such as a table, a column, and
     *            so on
     ...
     * @throws DomaNullPointerException
     *             if the {@code sqlException} is {@code null}
     */
    ...
    /**
     * Returns the aggregation of the expression functions that are available in
     * the SQL templates.
     * 
