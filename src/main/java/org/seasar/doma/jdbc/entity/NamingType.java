 ...
 * A naming convention.
 * <p>
 * This convention resolves the table name from the entity name when
 * {@link Table#name()} is not specified at the entity class, and also resolves
 * the column name from the entity property name when {@link Column#name()} is
 * not specified at the property field.
 */
public enum NamingType {
    ...
    /**
     * Converts the camel case text to the text that is snake case and upper
     * case.
     * <p>
     * For examples:
     * <ul>
    ...
    /**
     * Converts the camel case text to the text that is snake case and lower
     * case.
     * <p>
     * For examples:
     * <ul>
     ...
     * 
     * @param text
     *            the entity name or the property name
