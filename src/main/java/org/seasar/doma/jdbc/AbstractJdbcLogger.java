...
public abstract class AbstractJdbcLogger<LEVEL> implements JdbcLogger {
    ...
    @Override
    public void logDaoMethodEntering(String callerClassName, String callerMethodName,
            Object... args) {
        logDaoMethodEntering(callerClassName, callerMethodName, args, defaultLevel,
                () -> Message.DOMA2220.getMessage(callerClassName, callerMethodName));
    }

    protected void logDaoMethodEntering(String callerClassName, String callerMethodName,
            Object args[], LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logDaoMethodExiting(String callerClassName, String callerMethodName,
            Object result) {
        logDaoMethodExiting(callerClassName, callerMethodName, result, defaultLevel,
                () -> Message.DOMA2221.getMessage(callerClassName, callerMethodName));
    }

    protected void logDaoMethodExiting(String callerClassName, String callerMethodName,
            Object result, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }
    ...
    public void logDaoMethodThrowing(String callerClassName, String callerMethodName,
            RuntimeException e) {
        logDaoMethodThrowing(callerClassName, callerMethodName, e, defaultLevel,
                () -> Message.DOMA2222.getMessage(callerClassName, callerMethodName,
                        e.getClass().getName()));
    }

    protected void logDaoMethodThrowing(String callerClassName, String callerMethodName,
            RuntimeException e, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }
    ...
    public void logSqlExecutionSkipping(String callerClassName, String callerMethodName,
        ...
        logSqlExecutionSkipping(callerClassName, callerMethodName, cause, defaultLevel,
                () -> Message.DOMA2223.getMessage(callerClassName, callerMethodName, cause.name()));
    }

    protected void logSqlExecutionSkipping(String callerClassName, String callerMethodName,
            SqlExecutionSkipCause cause, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }
    ...
    public void logTransactionBegun(String callerClassName, String callerMethodName,
        ...
        logTransactionBegun(callerClassName, callerMethodName, transactionId, defaultLevel,
                () -> Message.DOMA2063.getMessage(transactionId));
    }

    protected void logTransactionBegun(String callerClassName, String callerMethodName,
            String transactionId, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }
    ...
    public void logTransactionEnded(String callerClassName, String callerMethodName,
            String transactionId) {
        logTransactionEnded(callerClassName, callerMethodName, transactionId, defaultLevel,
                () -> Message.DOMA2064.getMessage(transactionId));
    }

    protected void logTransactionEnded(String callerClassName, String callerMethodName,
            String transactionId, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logTransactionSavepointCreated(String callerClassName, String callerMethodName,
            String transactionId, String savepointName) {
        logTransactionSavepointCreated(callerClassName, callerMethodName, transactionId,
                savepointName, defaultLevel,
                () -> Message.DOMA2065.getMessage(transactionId, savepointName));
    }

    protected void logTransactionSavepointCreated(String callerClassName, String callerMethodName,
            String transactionId, String savepointName, LEVEL level,
            Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logTransactionCommitted(String callerClassName, String callerMethodName,
            String transactionId) {
        logTransactionCommitted(callerClassName, callerMethodName, transactionId, defaultLevel,
                () -> Message.DOMA2067.getMessage(transactionId));
    }

    protected void logTransactionCommitted(String callerClassName, String callerMethodName,
            String transactionId, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logTransactionRolledback(String callerClassName, String callerMethodName,
            String transactionId) {
        logTransactionRolledback(callerClassName, callerMethodName, transactionId, defaultLevel,
                () -> Message.DOMA2068.getMessage(transactionId));
    }

    protected void logTransactionRolledback(String callerClassName, String callerMethodName,
            String transactionId, LEVEL level, Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logTransactionSavepointRolledback(String callerClassName, String callerMethodName,
            String transactionId, String savepointName) {
        logTransactionSavepointRolledback(callerClassName, callerMethodName, transactionId,
                savepointName, defaultLevel,
    ...
    protected void logTransactionSavepointRolledback(String callerClassName,
            String callerMethodName, String transactionId, String savepointName, LEVEL level,
            Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, null, messageSupplier);
    }

    @Override
    public void logTransactionRollbackFailure(String callerClassName, String callerMethodName,
            String transactionId, SQLException e) {
        logTransactionRollbackFailure(callerClassName, callerMethodName, e, defaultLevel,
                () -> Message.DOMA2070.getMessage(transactionId));
    }

    protected void logTransactionRollbackFailure(String callerClassName, String callerMethodName,
            SQLException e, LEVEL level, Supplier<String> messageSupplier) {
    ...
    public void logTransactionIsolationSettingFailure(String callerClassName,
            String callerMethodName, int transactionIsolationLevel, SQLException e) {
        logTransactionIsolationSettingFailure(callerClassName, callerMethodName,
                transactionIsolationLevel, e, defaultLevel,
                () -> Message.DOMA2072.getMessage(transactionIsolationLevel));
    }

    protected void logTransactionIsolationSettingFailure(String callerClassName,
            String callerMethodName, int transactionIsolationLevel, SQLException e, LEVEL level,
            Supplier<String> messageSupplier) {
        log(level, callerClassName, callerMethodName, e, messageSupplier);
    }
