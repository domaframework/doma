...
public final class HolderDescFactory {
   ...
   * @throws DomaIllegalArgumentException if the holder class is not annotated with the {@link
   *     Holder}
   * @throws HolderDescNotFoundException if the holder description is not found
   */
  public static <BASIC, HOLDER> HolderDesc<BASIC, HOLDER> getHolderDesc(
    ...
    try {
      ...
      throw new HolderDescNotFoundException(
          e.getCause(), holderClass.getName(), holderDescClassName);
    } catch (Exception e) {
   ...
   * @param holderClass the holder class
   * @param classHelper the class helper
   * @return the external holder description or {@code null} if it is not found
   * @throws DomaNullPointerException if any arguments are {@code null}
   */
  public static <BASIC, HOLDER> HolderDesc<BASIC, HOLDER> getExternalHolderDesc(
      Class<HOLDER> holderClass, ClassHelper classHelper) {
