...
public abstract class SqlTemplateBatchModifyQuery<ELEMENT> extends AbstractQuery
  ...
  protected SqlTemplateBatchModifyQuery(Class<ELEMENT> elementClass, SqlKind kind) {
  ...
  public void prepare() {
    super.prepare();
    assertNotNull(method, parameterName, elements, sqls);
  }
  ...
  protected void prepareSql() {
    ...
    var sqlBuilder =
        new NodePreparedSqlBuilder(
            ...
            this::expandColumns,
            this::populateValues);
    var sql = sqlBuilder.build(sqlTemplate.getSqlNode(), this::comment);
    sqls.add(sql);
  }
