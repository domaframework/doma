...
public class SqlTemplateBatchInsertQuery<ELEMENT> extends SqlTemplateBatchModifyQuery<ELEMENT>
    implements BatchInsertQuery {

  protected EntityHandler entityHandler;

  public SqlTemplateBatchInsertQuery(Class<ELEMENT> elementClass) {
  ...
  protected static class SqlFileBatchPreInsertContext<E> extends AbstractPreInsertContext<E> {
    ...
    public SqlFileBatchPreInsertContext(EntityDesc<E> entityDesc, Method method, Config config) {
  ...
  protected static class SqlFileBatchPostInsertContext<E> extends AbstractPostInsertContext<E> {
    ...
    public SqlFileBatchPostInsertContext(EntityDesc<E> entityDesc, Method method, Config config) {
      super(entityDesc, method, config);
    }
  }
}
