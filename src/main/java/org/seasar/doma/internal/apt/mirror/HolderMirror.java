...
public class HolderMirror {
    ...
    protected HolderMirror(AnnotationMirror annotationMirror) {
        assertNotNull(annotationMirror);
        this.annotationMirror = annotationMirror;
    }

    public static HolderMirror newInstance(TypeElement clazz,
            ProcessingEnvironment env) {
        assertNotNull(env);
        AnnotationMirror annotationMirror = ElementUtil.getAnnotationMirror(
                clazz, Holder.class, env);
        if (annotationMirror == null) {
            return null;
        }
        HolderMirror result = new HolderMirror(annotationMirror);
