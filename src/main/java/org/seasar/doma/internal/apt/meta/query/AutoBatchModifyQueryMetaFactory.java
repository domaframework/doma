...
public class AutoBatchModifyQueryMetaFactory
    ...
    protected void doParameters(AutoBatchModifyQueryMeta queryMeta) {
        ...
        EntityCtType entityCtType = iterableCtType.getElementCtType()
        ...
        validateEntityPropertyNames(entityCtType.getType(),
                batchModifyReflection.getAnnotationMirror(), batchModifyReflection.getInclude(),
