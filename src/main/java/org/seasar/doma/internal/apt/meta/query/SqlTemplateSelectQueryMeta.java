...
public class SqlTemplateSelectQueryMeta extends AbstractSqlTemplateQueryMeta {
  ...
  public SqlTemplateSelectQueryMeta(ExecutableElement method) {
    super(method);
  }
  ...
  public <P> void accept(QueryMetaVisitor<P> visitor, P p) {
    visitor.visitSqlTemplateSelectQueryMeta(this, p);
  }
}
