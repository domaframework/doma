 ...
 * 
 */
public class HolderConvertersMirror {
    ...
    protected HolderConvertersMirror(AnnotationMirror annotationMirror,
    ...
    public static HolderConvertersMirror newInstance(TypeElement typeElement,
            ProcessingEnvironment env) {
        assertNotNull(env);
        AnnotationMirror annotationMirror = ElementUtil.getAnnotationMirror(
                typeElement, HolderConverters.class, env);
        if (annotationMirror == null) {
            return null;
        }
        HolderConvertersMirror result = new HolderConvertersMirror(
