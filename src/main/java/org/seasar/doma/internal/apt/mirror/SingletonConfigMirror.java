...
public class SingletonConfigMirror {
    ...
    protected SingletonConfigMirror(AnnotationMirror annotationMirror,
    ...
    public static SingletonConfigMirror newInstance(TypeElement typeElement,
            ProcessingEnvironment env) {
        assertNotNull(env);
        AnnotationMirror annotationMirror = ElementUtil.getAnnotationMirror(
                typeElement, SingletonConfig.class, env);
        if (annotationMirror == null) {
            return null;
        }
        SingletonConfigMirror result = new SingletonConfigMirror(
