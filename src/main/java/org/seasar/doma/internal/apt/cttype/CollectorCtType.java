...
public class CollectorCtType extends AbstractCtType {
  ...
  public boolean hasWildcardType() {
    return returnCtType.getType() != null && returnCtType.getType().getKind() == TypeKind.WILDCARD
        || targetCtType.getType() != null && targetCtType.getType().getKind() == TypeKind.WILDCARD;
  }
