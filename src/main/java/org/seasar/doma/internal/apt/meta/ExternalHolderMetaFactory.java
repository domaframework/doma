...
public class ExternalHolderMetaFactory implements
    ...
    public ExternalHolderMetaFactory(ProcessingEnvironment env) {
        assertNotNull(env);
        this.env = env;
    }
    ...
    protected void doHolderType(TypeElement convElement, TypeMirror holderType,
        ...
        TypeElement holderElement = TypeMirrorUtil.toTypeElement(holderType,
                env);
        ...
        DeclaredType declaredType = TypeMirrorUtil.toDeclaredType(holderType,
                env);
