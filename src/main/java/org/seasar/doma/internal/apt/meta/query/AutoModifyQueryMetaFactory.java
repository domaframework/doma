...
public class AutoModifyQueryMetaFactory extends AbstractQueryMetaFactory<AutoModifyQueryMeta> {
    ...
    protected void doParameters(AutoModifyQueryMeta queryMeta) {
        ...
        EntityCtType entityCtType = parameterMeta.getCtType()
        ...
        validateEntityPropertyNames(entityCtType.getType(), modifyReflection.getAnnotationMirror(),
                modifyReflection.getInclude(), modifyReflection.getExclude());
    }
}
