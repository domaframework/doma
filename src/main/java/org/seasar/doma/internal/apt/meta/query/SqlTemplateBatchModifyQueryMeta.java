...
public class SqlTemplateBatchModifyQueryMeta extends AbstractSqlTemplateQueryMeta {
  ...
  public SqlTemplateBatchModifyQueryMeta(ExecutableElement method) {
    super(method);
  }
  ...
  public <P> void accept(QueryMetaVisitor<P> visitor, P p) {
    visitor.visitSqlTemplateBatchModifyQueryMeta(this, p);
  }
}
