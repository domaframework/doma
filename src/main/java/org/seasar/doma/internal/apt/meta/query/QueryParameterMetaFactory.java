...
public class QueryParameterMetaFactory {
  ...
  private CtType createCtType() {
    ...
    CtType ctType =
        ctTypes.toCtType(
            type,
            List.of(
                ctTypes::newIterableCtType,
                ctTypes::newEntityCtType,
                ...
                ctTypes::newSelectOptionsCtType,
                ctTypes::newFunctionCtType,
                ctTypes::newCollectorCtType,
                ctTypes::newReferenceCtType,
                ctTypes::newBiFunctionCtType));
  ...
  private class CtTypeValidator extends SimpleCtTypeVisitor<Void, Void, RuntimeException> {
    ...
    public Void visitBiFunctionCtType(BiFunctionCtType ctType, Void p) throws RuntimeException {
      if (ctType.isRawType()) {
        throw new AptException(
            Message.DOMA4438, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      if (ctType.hasWildcardType()) {
        throw new AptException(
            Message.DOMA4439, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      return null;
    }
    ...
    public Void visitReferenceCtType(ReferenceCtType ctType, Void p) throws RuntimeException {
      ...
      if (ctType.hasWildcardType()) {
        throw new AptException(
            Message.DOMA4112, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
    ...
    public Void visitCollectorCtType(CollectorCtType ctType, Void p) throws RuntimeException {
      if (ctType.isRawType()) {
        throw new AptException(
            Message.DOMA4258, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      if (ctType.hasWildcardType()) {
        throw new AptException(
            Message.DOMA4259, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
    ...
    public Void visitFunctionCtType(FunctionCtType ctType, Void p) throws RuntimeException {
      if (ctType.isRawType()) {
        throw new AptException(
            Message.DOMA4240, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      if (ctType.hasWildcardType()) {
        throw new AptException(
            Message.DOMA4241, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
    ...
    public Void visitHolderCtType(HolderCtType ctType, Void p) throws RuntimeException {
      if (ctType.isRawType()) {
        throw new AptException(
            Message.DOMA4208, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      if (ctType.hasWildcardType() || ctType.hasTypevarType()) {
        throw new AptException(
            Message.DOMA4209, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      return null;
    }
    ...
    public Void visitOptionalCtType(OptionalCtType ctType, Void p) throws RuntimeException {
      if (ctType.isRawType()) {
        throw new AptException(
            Message.DOMA4236, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      if (ctType.hasWildcardType() || ctType.hasTypevarType()) {
        throw new AptException(
            Message.DOMA4237, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
  ...
  private class OptionalElementValidator extends SimpleCtTypeVisitor<Void, Void, RuntimeException> {
    ...
    public Void visitHolderCtType(final HolderCtType ctType, Void p) throws RuntimeException {
      ...
      if (ctType.hasWildcardType() || ctType.hasTypevarType()) {
        throw new AptException(
            Message.DOMA4239, parameterElement, new Object[] {ctType.getQualifiedName()});
      }
      return null;
    }
  }

  private class FunctionTargetValidator extends SimpleCtTypeVisitor<Void, Void, RuntimeException> {
  ...
  private class CollectorTargetValidator extends SimpleCtTypeVisitor<Void, Void, RuntimeException> {
