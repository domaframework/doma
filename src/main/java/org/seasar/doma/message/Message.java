...
public enum Message implements MessageResource {
  ...
  DOMA2002(
      "While the column[{0}] is in the result set, the property that corresponds the column is not found in the entity class[{2}]. You have to do any of followings: 1)Define the property whose name is [{1}] in the entity class. 2)Annotate @Column(name = \"{0}\") to the property in the entity class. 3)Implement UnknownColumnHandler to ignore unknown columns and configure in org.seasar.doma.jdbc.Config.\\nPATH=[{3}].\\nSQL=[{4}]\""),
  ...
  DOMA2125(
      "Failed to parse the SQL on line [{1}] at column [{2}]. The identifier is not found before the token \":\" in the block comment \"/*%for ...*/\". SQL[{0}]"),
  DOMA2126(
      "Failed to parse the SQL on line [{1}] at column [{2}]. The expression is not found after the token \":\" in the block comment \"/*%for ...*/\". SQL[{0}]"),
  DOMA2129(
  ...
  DOMA2202(
      "The holder description class[{1}] that corresponds to the holder class[{0}] is not found. The cause is as follows: {2}"),
  DOMA2203(
      "The holder entity class[{1}] that corresponds to the entity class[{0}] is not found. The cause is as follows: {2}"),
  DOMA2204(
      "The type of the class[{0}] must be the basic type or the holder type. The detail cause as follows: {1}"),
  DOMA2205("The class[{0}] must be annotated with @Holder."),
  ...
  DOMA2229("The parameter type is different between batched queries."),
  ...
  DOMA3029(
      "Failed to analyze the expression[{0}] at column[{1}]. The name of the static field or method must follow closely the token \"@\"."),
  DOMA3030(
      "Failed to analyze the expression[{0}] at column[{1}]. The character[{2}] that follows closely token \"@\" is illegal as the first character in a Java identifier."),
  DOMA3031(
  ...
  DOMA4026("The name that ends with \"{0}\" may be duplicate with the auto-generated class."),
  DOMA4030(
  ...
  DOMA4036("When @GeneratedValue is used, @Id must be only one in the class hierarchy."),
  ...
  DOMA4088(
      "When you use @Id or @Version, you must not annotate @Column(insertable=false) to the same field."),
  DOMA4089(
  ...
  DOMA4096(
      "The class[{0}] is not supported as a persistent type. If you intend to map the class to the external holder class with @ExternalHolder, the configuration may be not enough. Check the class that is annotated with @HolderConverters and the annotation processing option \"doma.holder.converters\"."),
  ...
  DOMA4174("Cannot annotate anything but enum types."),
  DOMA4176(
      "The accessor method[{0}] is not found. The method must return the type[{1}], accept no parameters and be non-private, no-args and non-static."),
  DOMA4177(
  ...
  DOMA4191(
      "@ExternalHolder can be annotated to the subtype of org.seasar.doma.jdbc.holder.HolderConverter."),
  DOMA4192("The class[{0}] that is annotated with @ExternalHolder must not be abstract."),
  DOMA4193(
      "The class[{0}] that is annotated with @ExternalHolder must have a public and no-args constructor."),
  DOMA4194(
      "The second type argument[{0}] of org.seasar.doma.jdbc.holder.HolderConverter is not supported as a persistent type."),
  DOMA4196("The type[{0}] is not annotated with @ExternalHolder."),
  DOMA4197(
      "The package of the first type argument[{0}] of org.seasar.doma.jdbc.holder.HolderConverter is default package. It is not supported."),
  DOMA4198("The class that is annotated with @ExternalHolder must be a top level class."),
  DOMA4200(
      "The class[{0}] that is specified for the annotation processing option \"doma.holder.converters\" is not found."),
  DOMA4201(
      "The class[{0}] that is specified for the annotation processing option \"doma.holder.converters\" is not annotated with @HolderConverters."),
  DOMA4202("The type argument of org.seasar.doma.jdbc.entity.EntityListener is not resolved."),
  DOMA4203(
      "All type arguments of the type[{0}] that is first type argument of org.seasar.doma.jdbc.holder.HolderConverter must be wildcard."),
  ...
  DOMA4233(
      "The type argument of the class[{0}] must not be a wildcard or type variable. Instead specify the basic type or the holder type."),
  DOMA4234("The entity class[{0}] as a type argument of java.util.Optional must not be abstract."),
  DOMA4235(
      "The type argument[{0}] is not supported for java.util.Optional. Supported types are as follows: basic type, holder class and entity class."),
  ...
  DOMA4246(
      "The return type[{0}] and the second type argument of java.util.function.Function are not same."),
  DOMA4247(
  ...
  DOMA4251(
      "When the primitive type is specified for the valueType element of @Holder, the acceptNull element of @Holder must be \"false\"."),
  ...
  DOMA4265("The return type[{0}] and the third type argument of Collector are not same."),
  DOMA4266(
  ...
  DOMA4267(
      "The type argument[{0}] is not supported for java.util.Optional of java.util.List. Supported types are as follows: basic type and holder type."),
  DOMA4268(
  ...
  DOMA4273(
      "The type argument[{0}] is not supported for java.util.Optional of java.util.stream.Stream. Supported types are as follows: basic type and holder type."),
  DOMA4274(
  ...
  DOMA4275(
      "The type[{0}] is not public and static. The holder class or the enclosing type of it must be public and static."),
  DOMA4276(
      "The type[{0}] is a local or anonymous class. The holder class or the enclosing type of it must be a top level or member class."),
  DOMA4277(
      "The simple name of the type[{0}] contains \"$\" or \"__\". The simple name of the holder class or the enclosing type of it must not contain them."),
  DOMA4278(
      "The type[{0}] is not public and static. The first type argument of HolderConverter or the enclosing type of it must be must be public and static."),
  DOMA4279(
      "The type[{0}] is a local or anonymous class. The first type argument of HolderConverter or the enclosing type of it must be a top level or member class."),
  DOMA4280(
      "The simple name of the type[{0}] contains \"$\" or \"__\". The simple name of the first type argument of HolderConverter or the enclosing type of it must not contain them."),
  DOMA4281(
  ...
  DOMA4436("The return type[{0}] is not same with the third type argument of BiFunction."),
