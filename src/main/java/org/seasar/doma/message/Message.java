...
public enum Message implements MessageResource {
    ...
    DOMA4056("@Selectのstrategy要素にSelectStrategyType.ITERATEを設定した場合、IterationCallback型のパラメータが必要です。"),
    DOMA4057("IterationCallback型のパラメータを利用するには、strategy要素にSelectStrategyType.ITERATEを設定しなければいけません。"),
