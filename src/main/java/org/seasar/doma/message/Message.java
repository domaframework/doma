...
public enum Message implements MessageResource {
    ...
    DOMA4200("注釈処理のオプション holder.converters で指定されたクラス[{0}]が見つかりません。"),
    DOMA4201("注釈処理のオプション holder.converters で指定されたクラス[{0}]に@HolderConvertersが注釈されていません。"),
    ...
    DOMA4301("クラス[{0}]の型引数にワイルドカードや型パラメータは永続プロパティとして使用できません。基本型やドメインクラスを指定できます。"),
