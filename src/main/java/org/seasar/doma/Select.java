 ...
 * {@code null}
 * <li>{@link SqlFileNotFoundException} if {@code sqlFile} is {@code true} and a
 * SQL file is not found
 * <li>{@link UnknownColumnException} if a property whose mapped column is
 * included in a result set is not found
 * <li>{@link NonUniqueResultException} if an unique row is expected but two or
 * more rows are found in a result set
 * <li>{@link NonSingleColumnException} if a single column is expected but two
 * or more columns are found in a result set
 * <li>{@link NoResultException} if {@link #ensureResult} is {@code true} and no
 * row is found in a result set
 * <li>{@link ResultMappingException} if {@link #ensureResultMapping()} is
 * {@code true} and all entity properties are not mapped to columns of a result
 * set
...
public @interface Select {
     ...
     * The fetch size.
     * <p>
     * If not specified, {@link Config#getFetchSize()} is used.
     * 
     ...
     * <p>
     * If not specified, {@link Config#getMaxRows()} is used.
     * 
     ...
     * <p>
     * if {@code true} and no row is found, {@link NoResultException} is thrown
     * from the method.
     */
     ...
     * {@link ResultMappingException} is thrown from the method.
     */
