 ...
 *
 * <p>The holder class is the user defined type that wraps a basic value. It can be mapped to a
 * database column.
 *
...
public @interface Holder {
  ...
  /** Whether the constructor or the factory method accepts {@code null} as an argument. */
