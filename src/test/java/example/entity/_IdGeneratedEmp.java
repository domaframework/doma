...
public class _IdGeneratedEmp extends AbstractEntityDesc<IdGeneratedEmp> {
  ...
  public final GeneratedIdPropertyDesc<IdGeneratedEmp, Integer, Integer> id =
      new GeneratedIdPropertyDesc<>(
  ...
  public final DefaultPropertyDesc<IdGeneratedEmp, String, String> name =
  ...
  public final DefaultPropertyDesc<IdGeneratedEmp, BigDecimal, BigDecimal> salary =
      new DefaultPropertyDesc<>(
          IdGeneratedEmp.class,
  ...
  public final VersionPropertyDesc<IdGeneratedEmp, Integer, Integer> version =
