...
public class _ImmutableEmp extends AbstractEntityDesc<ImmutableEmp> {
    ...
    public final AssignedIdPropertyDesc<ImmutableEmp, Integer, Integer> id = new AssignedIdPropertyDesc<>(
            ImmutableEmp.class, () -> new BasicScalar<>(new IntegerWrapper(), false), "id", "ID",
            __namingType, false);

    public final DefaultPropertyDesc<ImmutableEmp, String, String> name = new DefaultPropertyDesc<>(
            ImmutableEmp.class, () -> new BasicScalar<>(new StringWrapper(), false), "name", "NAME",
            __namingType, true, true, false);

    public final DefaultPropertyDesc<ImmutableEmp, BigDecimal, BigDecimal> salary = new DefaultPropertyDesc<>(
            ImmutableEmp.class, () -> new BasicScalar<>(new BigDecimalWrapper(), false), "salary",
    ...
    public final VersionPropertyDesc<ImmutableEmp, Integer, Integer> version = new VersionPropertyDesc<>(
            ImmutableEmp.class, () -> new BasicScalar<>(new IntegerWrapper(), false), "version",
    ...
    public ImmutableEmp newEntity(Map<String, Property<ImmutableEmp, ?>> args) {
        return new ImmutableEmp((Integer) (args.containsKey("id") ? args.get("id").get() : null),
