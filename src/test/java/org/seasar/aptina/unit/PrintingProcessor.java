 ...
 *
 * <p>{@link AptinaTestCase} のサブクラスで， {@link AptinaTestCase#addProcessor(Processor...)}
 * にこのクラスを加えることで， コンパイル対象の {@link Element} 階層を確認することができます．
 *
 * <p>次のサンプルは， {@code src/test/java} フォルダにある {@code TestSource.java} をコンパイルし， {@code
 * PrintingProcessor} で {@link Element} 階層をコンソールに出力するテストクラスです．
 *
 * <pre>
