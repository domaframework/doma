...
class AssertionUtils {
   ...
   * @param name パラメータの名前
   * @param param パラメータ
   * @throws AssertionError パラメータが {@code null} の場合
   */
   ...
   * @param name 配列の名前
   * @param string 文字列
   * @throws AssertionError 文字列が {@code null} または場合
   */
   ...
   * @param name 配列の名前
   * @param array 配列
   * @throws AssertionError 配列が {@code null} または空の場合
   */
   ...
   * @param actual 実際の値
   * @throws AssertionError 期待する値が実際の値と異なった場合
   */
