...
/** */
public final class _NotTopLevelEntity__Hoge
    extends org.seasar.doma.jdbc.entity.AbstractEntityDesc<NotTopLevelEntity.Hoge> {
  ...
  private final java.util.function.Supplier<
          org.seasar.doma.jdbc.entity.NullEntityListener<NotTopLevelEntity.Hoge>>
      __listenerSupplier;
  ...
  private final java.util.List<
          org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
      __idPropertyDescs;

  private final java.util.List<
          org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
      __entityPropertyDescs;

  private final java.util.Map<
          String, org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
      __entityPropertyDescMap;
  ...
  private _NotTopLevelEntity__Hoge() {
    ...
    java.util.List<org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
        __idList = new java.util.ArrayList<>();
    java.util.List<org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
        __list = new java.util.ArrayList<>(0);
    java.util.Map<String, org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
        __map = new java.util.HashMap<>(0);
  ...
  @Override
  public java.util.List<org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>>
      getEntityPropertyDescs() {
    return __entityPropertyDescs;
  }

  @Override
  public org.seasar.doma.jdbc.entity.EntityPropertyDesc<NotTopLevelEntity.Hoge, ?>
      getEntityPropertyDesc(String __name) {
  ...
  @Override
  public org.seasar.doma.jdbc.entity.GeneratedIdPropertyDesc<NotTopLevelEntity.Hoge, ?, ?>
      getGeneratedIdPropertyDesc() {
    return null;
  }

  @Override
  public org.seasar.doma.jdbc.entity.VersionPropertyDesc<NotTopLevelEntity.Hoge, ?, ?>
      getVersionPropertyDesc() {
    return null;
  }
  ...
  @Override
  public NotTopLevelEntity.Hoge getOriginalStates(NotTopLevelEntity.Hoge __entity) {
    return null;
  }
