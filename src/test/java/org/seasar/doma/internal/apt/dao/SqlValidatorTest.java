...
public class SqlValidatorTest extends AptTestCase {
  ...
  public void testExpand() throws Exception {
    ...
    ExecutableElement methodElement = createMethodElement(target, "testExpand", String.class);
    LinkedHashMap<String, TypeMirror> parameterTypeMap = createParameterTypeMap(methodElement);
    SqlValidator validator =
        new SqlValidator(
            getProcessingEnvironment(),
            ...
            true,
            false);
    SqlParser parser = new SqlParser("select /*%expand*/* from emp where name = /* name */'aaa'");
    SqlNode sqlNode = parser.parse();
    sqlNode.accept(validator, null);
  }
