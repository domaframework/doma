...
public class _UserAddress implements EmbeddableDesc<UserAddress> {
    ...
    public <ENTITY> List<EntityPropertyDesc<ENTITY, ?>> getEmbeddablePropertyDescs(
        ...
        return java.util.Arrays
                .asList(new org.seasar.doma.jdbc.entity.DefaultPropertyDesc<ENTITY, java.lang.String, Object>(
                        entityClass,
                        () -> new org.seasar.doma.wrapper.StringWrapper(),
                        null, embeddedPropertyName + ".city", "",
                        namingType, true, true, false),
                        new org.seasar.doma.jdbc.entity.DefaultPropertyDesc<ENTITY, java.lang.String, Object>(
                                entityClass,
                                () -> new org.seasar.doma.wrapper.StringWrapper(),
