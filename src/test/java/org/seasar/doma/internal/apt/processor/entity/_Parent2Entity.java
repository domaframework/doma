...
public class _Parent2Entity extends AbstractEntityType<Parent2Entity> {
  ...
  public DefaultPropertyType<Object, Parent2Entity, Integer, Integer> $aaa =
  ...
  public DefaultPropertyType<Object, Parent2Entity, Integer, Integer> $bbb =
      new DefaultPropertyType<>(
          Parent2Entity.class,
          Integer.class,
          Integer.class,
  ...
  @Override
  public TenantIdPropertyType<Object, Parent2Entity, ?, ?> getTenantIdPropertyType() {
    return null;
  }
