...
```groovy
dependencies {
    implementation("org.seasar.doma:doma-core:2.55.3")
    annotationProcessor("org.seasar.doma:doma-processor:2.55.3")
}
```
...
```groovy
dependencies {
    implementation("org.seasar.doma:doma-kotlin:2.55.3")
    kapt("org.seasar.doma:doma-processor:2.55.3")
}
```
