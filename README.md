...
dependencies {
    implementation("org.seasar.doma:doma-core:3.9.0.2")
    annotationProcessor("org.seasar.doma:doma-processor:3.9.0.2")
}
```
...
dependencies {
    implementation("org.seasar.doma:doma-kotlin:3.9.0.2")
    kapt("org.seasar.doma:doma-processor:3.9.0.2")
}
```
...
...
<properties>
    <doma.version>3.9.0.2</doma.version>
</properties>
...
<dependencies>
    <dependency>
