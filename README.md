...
dependencies {
    implementation("org.seasar.doma:doma-core:3.9.0.1")
    annotationProcessor("org.seasar.doma:doma-processor:3.9.0.1")
}
```
...
dependencies {
    implementation("org.seasar.doma:doma-kotlin:3.9.0.1")
    kapt("org.seasar.doma:doma-processor:3.9.0.1")
}
```
...
...
<properties>
    <doma.version>3.9.0.1</doma.version>
</properties>
...
<dependencies>
    <dependency>
