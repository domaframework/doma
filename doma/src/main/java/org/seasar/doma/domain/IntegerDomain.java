 ...
 *            ドメインの型
 */
public abstract class IntegerDomain<D extends IntegerDomain<D>>
     ...
     *            値
     */
    protected IntegerDomain(Integer value) {
    ...
    @Override
    public void setDomain(NumberDomain<Integer, D> other) {
        if (other == null) {
    ...
    public <R, P, TH extends Throwable> R accept(
        ...
        if (IntegerDomainVisitor.class.isInstance(visitor)) {
            @SuppressWarnings("unchecked")
            IntegerDomainVisitor<R, P, TH> v = IntegerDomainVisitor.class
                    .cast(visitor);
    ...
    public boolean equals(Object o) {
        ...
        IntegerDomain<?> other = IntegerDomain.class.cast(o);
        if (value == null) {
