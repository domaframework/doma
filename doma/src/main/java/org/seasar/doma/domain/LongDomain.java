 ...
 *            ドメインの型
 */
public abstract class LongDomain<D extends LongDomain<D>>
     ...
     *            値
     */
    protected LongDomain(Long value) {
    ...
    @Override
    public void setDomain(NumberDomain<Long, D> other) {
        if (other == null) {
    ...
    public <R, P, TH extends Throwable> R accept(
        ...
        if (LongDomainVisitor.class.isInstance(visitor)) {
            @SuppressWarnings("unchecked")
            LongDomainVisitor<R, P, TH> v = LongDomainVisitor.class
                    .cast(visitor);
    ...
    public boolean equals(Object o) {
        ...
        LongDomain<?> other = LongDomain.class.cast(o);
        if (value == null) {
