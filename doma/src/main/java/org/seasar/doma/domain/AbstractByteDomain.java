 ...
 * 
 */
public abstract class AbstractByteDomain<D extends AbstractByteDomain<D>>
        extends AbstractComparableDomain<Byte, D> implements
        NumberDomain<Byte, D>, SerializableDomain<Byte, D> {

    private static final long serialVersionUID = 1L;

    protected AbstractByteDomain() {
        this(null);
    }

    protected AbstractByteDomain(Byte value) {
    ...
    public <R, P, TH extends Throwable> R accept(
        ...
        if (AbstractByteDomainVisitor.class.isInstance(visitor)) {
            ...
            AbstractByteDomainVisitor<R, P, TH> v = AbstractByteDomainVisitor.class
                    .cast(visitor);
    ...
    public boolean equals(Object o) {
        ...
        AbstractByteDomain<?> other = AbstractByteDomain.class.cast(o);
        if (value == null) {
