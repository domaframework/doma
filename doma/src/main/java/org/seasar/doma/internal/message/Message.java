...
public enum Message implements MessageResource {
    ...
    DOMA2041("自動コミットの無効化に失敗しました。原因は次のものです。{1}"),
    DOMA2042("自動コミットの有効化に失敗しました。原因は次のものです。{1}"),
    DOMA2043("コミットに失敗しました。原因は次のものです。{1}"),
    DOMA2044("ロールバックに失敗しました。原因は次のものです。{1}"),
    DOMA2045("トランザクションを開始しようとしましたが、トランザクションがすでに開始されています。"),
    DOMA2046("トランザクションをコミットしようとしましたが、トランザクションが開始されていません。"),
    DOMA2048("コネクションを取得しようとしましたが、トランザクションが開始されていません。"),
    DOMA2049("コネクションの遅延取得に失敗しました。原因は次のものです。{1}"),
