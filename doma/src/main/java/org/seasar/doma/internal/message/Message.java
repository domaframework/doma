...
public enum Message implements MessageResource {
    ...
    DOMA4007("戻り値のjava.lang.Iterableのサブタイプに対する実型引数の型[{0}]はサポートされていません。"),
    ...
    DOMA4062("@ResultSetが注釈されたパラメータの型は、java.lang.Iterableのサブタイプでなければいけません。"),
    DOMA4063("@Functionの戻り値として型[{0}]はサポートされていません。"),
    DOMA4064("@Procedureが注釈されたメソッドの戻り値の型はvoidでなければいけません。"),
    DOMA4065("戻り値のjava.lang.Iterableのサブタイプに対する実型引数の型[{0}]は、サポートされていません。"),
    ...
    DOMA4155("戻り値のjava.lang.Iterableのサブタイプに対する実型引数のエンティティクラス[{0}]は抽象型であってはいけません。"),
    DOMA4156("戻り値のjava.lang.Iterableのサブタイプに対する実型引数のエンティティクラス[{0}]は抽象型であってはいけません。"),
    DOMA4157("java.lang.Iterableのサブタイプに対する実型引数のエンティティクラス[{0}]は抽象型であってはいけません。"),
