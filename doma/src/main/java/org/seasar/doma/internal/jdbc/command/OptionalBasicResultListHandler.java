 ...
 * @param <R>
 */
public class OptionalBasicResultListHandler<R> extends
        AbstractResultListHandler<Optional<R>> {

    protected final Supplier<Wrapper<R>> supplier;

    public OptionalBasicResultListHandler(Supplier<Wrapper<R>> supplier) {
