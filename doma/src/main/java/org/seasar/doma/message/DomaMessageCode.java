...
public enum DomaMessageCode implements MessageCode {
    ...
    DOMA4007("Collection型の型パラメータ[{0}]はサポートされていません。"),
    ...
    DOMA4027("Collection型の型パラメータは必須です。"),
    ...
    DOMA4041("パラメータのCollection型には型パラメータが必須です。"),
    DOMA4042("パラメータはCollection型のサブタイプでなければいけません。"),
    ...
    DOMA4061("Collection型の型パラメータ[{0}]はサポートされていません。"),
    DOMA4062("@ResultSetが注釈されたパラメータの型は、Collectionのサブタイプでなければいけません。"),
    DOMA4063("@Functionの戻り値として型[{0}]はサポートされていません。"),
    DOMA4064("@Procedureが注釈されたメソッドの戻り値の型はvoidでなければいけません。"),
    DOMA4065("戻り値のCollection型の型パラメータ[{0}]は、サポートされていません。"),
    ...
    DOMA4071("式[{0}]（[{1}]番目の文字付近）に含まれる変数もしくはメソッド[{2}]の型[{3}]にpublicで戻り値を持ちパラメータの数が[{4}]のメソッド[{5}]が見つかりません。"),
    DOMA4072("式[{0}]（[{1}]番目の文字付近）に含まれる変数もしくはメソッド[{2}]の型[{3}]が解決できません。コンパイルに失敗していませんか。"),
