...
public enum Message implements MessageResource {
    ...
    DOMA4124("ミュータブルなエンティティクラスは非privateな引数なしのコンストラクタを持たねばなりません。"),
    ...
    DOMA4222("イミュータブルなエンティティクラスを@Updateや@Insertが注釈されたメソッドのパラメータとする場合、戻り値はorg.seasar.doma.jdbc.Result<E>でなければいけません。型パラメータEの実型引数にはパラメータと同じエンティティクラスを指定してください。"),
    DOMA4223("イミュータブルなエンティティクラスを@BatchUpdateや@BatchInsertが注釈されたメソッドのパラメータとする場合、戻り値はorg.seasar.doma.jdbc.BatchResult<E>でなければいけません。型パラメータEの実型引数にはパラメータと同じエンティティクラスを指定してください。"),
