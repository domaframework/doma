...
public enum Message implements MessageResource {
    ...
    // TODO
    DOMA4221("イミュータブルなエンティティクラスには全プロパティを含んだ非privateなコンストラクタが必要"),
    // TODO
    DOMA4222("update/insertにおいて イミュータブルなエンティティをパラメータにする場合は戻り値はResult<E>でなければいけない。"),
    // TODO
    DOMA4223("イミュータブルなエンティティをパラメータにする場合は戻り値はResultBatch<E>でなければいけない。"),
