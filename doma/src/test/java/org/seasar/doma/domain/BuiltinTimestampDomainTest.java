 ...
 * 
 */
public class BuiltinTimestampDomainTest extends TestCase {

    public void testEquals() throws Exception {
        BuiltinTimestampDomain domain = new BuiltinTimestampDomain(Timestamp
                .valueOf("2009-05-08 16:31:10"));
        BuiltinTimestampDomain domain2 = new BuiltinTimestampDomain(Timestamp
                .valueOf("2009-05-08 16:31:10"));
