...
public class DoubleConverterTest extends TestCase {
    ...
    public void testNull() throws Exception {
        Double value = converter.convert(null, null);
        assertNull(value);
    }

    public void testLong() throws Exception {
        Double value = converter.convert(100L, null);
        assertEquals(new Double(100), value);
    }

    public void testString() throws Exception {
        Double value = converter.convert("100", null);
        assertEquals(new Double(100), value);
    }

    public void testStringWithPattern() throws Exception {
        Double value = converter.convert("(100)", "(0)");
        assertEquals(new Double(100), value);
    }
