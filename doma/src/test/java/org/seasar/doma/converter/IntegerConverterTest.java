...
public class IntegerConverterTest extends TestCase {
    ...
    public void testNull() throws Exception {
        Integer value = converter.convert(null, null);
        assertNull(value);
    }

    public void testLong() throws Exception {
        Integer value = converter.convert(100L, null);
        assertEquals(new Integer(100), value);
    }

    public void testString() throws Exception {
        Integer value = converter.convert("100", null);
        assertEquals(new Integer(100), value);
    }

    public void testStringWithPattern() throws Exception {
        Integer value = converter.convert("(100)", "(0)");
        assertEquals(new Integer(100), value);
    }
}
