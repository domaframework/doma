...
by integrating the Entityql and NativeSql DSLs from the [\1](\1).
...
See [\1](\1) and refer to the following options:
...
The delete statement follows the same rules as the [\1](\1).
...
The update statement follows the same specifications as the [\1](\1).
