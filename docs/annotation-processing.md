...
Use [the compilerArgs property](https://docs.gradle.org/current/dsl/org.gradle.api.tasks.compile.CompileOptions.html#org.gradle.api.tasks.compile.CompileOptions:compilerArgs):
...
Use [the compilerArgs parameter](https://maven.apache.org/plugins/maven-compiler-plugin/examples/pass-compiler-arguments.html):
...
Use the Gradle plugin [com.diffplug.eclipse.apt](https://plugins.gradle.org/plugin/com.diffplug.eclipse.apt)
