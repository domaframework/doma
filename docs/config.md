...
See also: [DriverManager, the service provider mechanism and memory leaks][tomcat driver]
:::
...
[tomcat driver]: http://tomcat.apache.org/tomcat-7.0-doc/jndi-datasource-examples-howto.html#DriverManager,_the_service_provider_mechanism_and_memory_leaks
