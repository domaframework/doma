...
/**
 * An {@link AutoBatchUpdateQuery} that defers SQL generation until each entity is executed.
 *
 * <p>The standard {@link AutoBatchUpdateQuery} builds {@link PreparedSql} for every entity in the
 ...
 */
public class ChunkedAutoBatchUpdateQuery<ENTITY> extends AutoBatchUpdateQuery<ENTITY>
    implements ChunkedBatchUpdateQuery {
   ...
   */
  public ChunkedAutoBatchUpdateQuery(EntityType<ENTITY> entityType) {
    super(entityType);
  }
   ...
   * call, then runs pre-update hooks and SQL assembly for each subsequent entity. The internal
