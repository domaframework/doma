 ...
 *
 * <p>This interface provides methods to access and modify the entity being inserted,
...
public interface PreInsertContext<E> {
   ...
   *
   * <p>This is the entity instance before any modifications made by entity listeners
   * in their preInsert methods.
   *
   ...
   *
   * <p>This method indicates how the insert operation should handle duplicate key
