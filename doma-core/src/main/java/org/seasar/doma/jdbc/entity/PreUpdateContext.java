 ...
 * typically used in entity listener implementations to perform custom logic before an update
 * operation.
 *
...
public interface PreUpdateContext<E> {
   ...
   *
   * <p>This method checks if any property of the entity has been modified by comparing the current
   * values with the original values stored in the {@link OriginalStates} field.
   *
   ...
   *
   * <p>This is the entity instance after any modifications made by entity listeners in their
   * preUpdate methods.
   *
