 ...
 *
 * <p>A version property is annotated with {@link org.seasar.doma.Version} and contains
 * a numeric value that is automatically incremented during update operations. This
 * property is used to detect concurrent modifications to the same entity.
 *
...
public class VersionPropertyType<ENTITY, BASIC extends Number, CONTAINER>
   ...
   *
   * <p>This method sets the version value only if the current value is null or negative.
   * This is typically used when initializing a new entity or when loading an entity
   * from the database.
   *
   ...
   *
   * <p>This method is called during update operations to increment the version number,
   * which is essential for optimistic locking. The incremented version value is used
   * in the WHERE clause of the update statement to ensure that the record has not
   ...
   *
   * <p>This class is used by the {@link #setIfNecessary} method to set the version value
   ...
   *
   * <p>This class is used by the {@link #increment} method to increment the version value
   * during update operations, which is essential for optimistic locking.
   */
