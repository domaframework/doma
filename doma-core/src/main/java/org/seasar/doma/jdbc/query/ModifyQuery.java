...
public interface ModifyQuery extends Query {
  ...
  /**
   * Returns the column name of the generated ID property, or {@code null} if not available.
   *
   * @return the generated ID column name, or {@code null}
   */
  default String getGeneratedIdColumnName() {
    return null;
  }
