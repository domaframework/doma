...
public interface Dialect {
  ...
  /**
   * Generates an upsert query based on the provided context.
   *
   * @param context the upsert context
   * @return the upsert query builder
   */
  UpsertBuilder getUpsertBuilder(UpsertContext context);
}
