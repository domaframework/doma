...
public class StandardDialect implements Dialect {
  ...
  private static final ColumnExpressions COLUMN_EXPRESSIONS = new StandardColumnExpressions();
  ...
  public static class StandardColumnExpressions implements ColumnExpressions {
    @Override
    public ConcatKind getConcatKind() {
      return ConcatKind.FUNCTION;
    }
  }
}
