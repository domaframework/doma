...
class EntityqlMultiInsertTest {
  ...
  void insertInto() {
    ...
    Emp_ e = new Emp_();
    Buildable<?> stmt = entityql.insertMulti(e, Arrays.asList(emp, emp2));
  ...
  void include() {
    ...
    Emp_ e = new Emp_();
    Buildable<?> stmt =
        entityql.insertMulti(e, Arrays.asList(emp, emp2), settings -> settings.include(e.salary));
  ...
  void exclude() {
    ...
    Emp_ e = new Emp_();
    Buildable<?> stmt =
        entityql.insertMulti(e, Arrays.asList(emp, emp2), settings -> settings.exclude(e.salary));
  ...
  void empty() {
    Emp_ e = new Emp_();
    Buildable<?> stmt = entityql.insertMulti(e, Collections.emptyList());
