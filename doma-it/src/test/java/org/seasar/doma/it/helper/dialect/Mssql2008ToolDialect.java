 ...
 * 
 */
public class Mssql2008ToolDialect extends StandardToolDialect {
    ...
    public SqlBlockContext createSqlBlockContext() {
        return new Mssql2008SqlBlockContext();
    }

    public static class Mssql2008SqlBlockContext extends StandardSqlBlockContext {

        protected Mssql2008SqlBlockContext() {
