...
CREATE TABLE LARGE_OBJECT(ID INT NOT NULL PRIMARY KEY, NAME VARCHAR(20), LARGE_NAME VARCHAR(MAX), BYTES VARBINARY(2000), LARGE_BYTES VARBINARY(MAX), DTO VARBINARY(2000), LARGE_DTO VARBINARY(MAX));
CREATE TABLE TENSE (ID INT PRIMARY KEY,DATE_DATE DATETIME, DATE_TIME DATETIME, DATE_TIMESTAMP DATETIME, CAL_DATE DATETIME, CAL_TIME DATETIME, CAL_TIMESTAMP DATETIME, SQL_DATE DATETIME, SQL_TIME DATETIME, SQL_TIMESTAMP DATETIME);
CREATE TABLE JOB (ID INT NOT NULL PRIMARY KEY, JOB_TYPE VARCHAR(20));
CREATE TABLE AUTHORITY (ID INT NOT NULL PRIMARY KEY, AUTHORITY_TYPE INTEGER);
...
INSERT INTO TENSE VALUES (1, '2005-02-14', '1970-01-01 12:11:10', '2005-02-14 12:11:10', '2005-02-14', '1970-01-01 12:11:10', '2005-02-14 12:11:10', '2005-02-14', '1970-01-01 12:11:10', '2005-02-14 12:11:10');
...
INSERT INTO MY_ID_GENERATOR VALUES('TableStrategy5', 1);
...
CREATE PROCEDURE [dbo].[PROC_SIMPLETYPE_TIME_PARAM]
    @param1 datetime
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE PROCEDURE [dbo].[PROC_DTO_TIME_PARAM]
    @param1 datetime,
...
CREATE FUNCTION [dbo].[FUNC_SIMPLETYPE_TIME_PARAM] (
    @param1 datetime)
RETURNS datetime
AS
BEGIN
...
CREATE FUNCTION [dbo].[FUNC_DTO_TIME_PARAM](
    @param1 datetime,
    @param2 int)
RETURNS datetime
AS
