CREATE SEQUENCE SEQUENCE_STRATEGY_ID AS INTEGER START WITH 1 INCREMENT BY 100;
CREATE SEQUENCE MY_SEQUENCE_STRATEGY_ID AS INTEGER START WITH 1 INCREMENT BY 100;
